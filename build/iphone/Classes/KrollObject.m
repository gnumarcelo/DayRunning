...
//@interface DayRunningObject : NSObject
//@end

@interface DayRunningObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[DayRunningObject class]])
		{
			for (NSString *key in [[(DayRunningObject*)o modules] allKeys])
			{
