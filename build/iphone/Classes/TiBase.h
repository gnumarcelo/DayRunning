...
// in simulator we redefine to format for DayRunning Developer console
...
{\
	NSString * exceptionName = [@"org.dayrunning." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.dayrunning";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIDayRunningNativeItemNone = -1, 
	UIDayRunningNativeItemSpinner = -2,
	UIDayRunningNativeItemProgressBar = -3,
	
	UIDayRunningNativeItemSlider = -4,
	UIDayRunningNativeItemSwitch = -5,
	UIDayRunningNativeItemMultiButton = -6,
	UIDayRunningNativeItemSegmented = -7,
	
	UIDayRunningNativeItemTextView = -8,
	UIDayRunningNativeItemTextField = -9,
	UIDayRunningNativeItemSearchBar = -10,
	
	UIDayRunningNativeItemPicker = -11,
	UIDayRunningNativeItemDatePicker = -12,
	
	UIDayRunningNativeItemInfoLight = -13,
	UIDayRunningNativeItemInfoDark = -14,
	
	UIDayRunningNativeItemDisclosure = -15,
	
	UIDayRunningNativeItemContactAdd = -16
};
